...
class Character {
private:
	int _charFrame = 0, _walking = 0, _walkingTimer = 0, _blinkTimer = 1, _idleTimer = 1, _lazerTimer = 0, _lTimer = 0, _lFrame = 0;
	int _vel = static_cast<int>(SCALE * 1.5), _dir = 0, _jump = 0, _fallingVel = 0, _jumpHeight = 0, _fVTicks = 0;
	double  _mouseAngle = 0, _mouseDist = 0;
...
public:
	...
	Character(SDL_Point, SpriteMngr *, TileMap *, SDL_Renderer *rend, Camera *cam = NULL);
};
